...
def get_openlex_save_data(output_dir, scene):
    ...
    original_pcd_path = (
        dataset_directory / scene / "scans" / "pcd_sampled_aligned_0.01.ply"
    )
    openmask3d_masks_path = latest_exp_folder / "pcd_sampled_aligned_0.01_masks.pt"
    openmask3d_mask_indices_path = (
        latest_exp_folder / "mesh_aligned_0.05_mask_indices.npy"
    )
    openmask3d_features_path = (
        latest_exp_folder / "pcd_sampled_aligned_0.01_openmask3d_features.npy"
    )
